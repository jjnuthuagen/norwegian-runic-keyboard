...
GLYPHS_TRADITIONAL = {
    "a": [("S",), ("L", 0, 346, -201, 263)],
    "b": [("S",), ("P", [(0, 676), (315, 508), (0, 357), (315, 218), (0, 38)])],
    "c": [("D", 0, 366, 120), ("V", 0, 470, CAP)],
    ...
    "p": [("S",), ("P", [(0, 676), (315, 508), (0, 357), (315, 218), (0, 38)]),
          ("O", 150, 522, 46), ("O", 150, 202, 46)],
    "q": [("S",), ("P", [(0, 676), (-262, 478), (0, 228)])],
    "r": [("S",), ("P", [(0, 676), (275, 535), (0, 345), (300, 38)])],
...
# Diagonals that attach ON the cap or baseline get half-shaved by the
# clamps -- the stroke starts thin and fattens. Attach by OUTER edge
# instead: 676 up top, 38 at the floor, exactly like the flats.
GLYPHS_HYBRID["q"] = [("S",), ("P", [(0, 676), (-262, 478), (0, 228)])]
GLYPHS_HYBRID["r"] = [("S",), ("P", [(0, 676), (260, 535), (0, 345), (300, 38)])]
